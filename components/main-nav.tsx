                ...
                <li className="row-span-3">
                  <NavigationMenuLink asChild>
                    <a
                      ...
                      href="/apply"
                    >
                      <div className="mt-4 mb-2 text-lg font-medium text-white">Apply for Funding</div>
                      <p className="text-sm leading-tight text-white/90">
                        Submit your open source project for a €100-500 microgrant
                      </p>
                    </a>
                  </NavigationMenuLink>
                </li>
                <ListItem href="/projects" title="Funded Projects">
                  Browse all the projects we've supported
                </ListItem>
                <ListItem href="/criteria" title="Selection Criteria">
